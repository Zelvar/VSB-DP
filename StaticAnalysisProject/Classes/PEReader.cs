// Downloaded from: https://gist.github.com/caioproiete/b51f29f74f5f5b2c59c39e47a8afc3a3
...
namespace StaticAnalysisProject.Classes
{
    ...
    public class PeReader
    {
        ...
        public struct IMAGE_SECTION_HEADER
        {
            ...
            {
                get { return new string(Name).Trim(new Char[] { ' ', '\t', '\0' }); }
            }
        }
